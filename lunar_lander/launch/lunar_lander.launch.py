...
def generate_launch_description():
    ...
    namespace = DeclareLaunchArgument(
        'namespace', default_value='lunar_lander',
    ...
    # Parameters
    lunar_lander_params_path = os.path.join(
        get_package_share_directory('lunar_lander'),
        'config',
        'lunar_lander_rl_config.yaml'
    )
    ...
    rl_node = Node(
        ...
        parameters=[lunar_lander_params_path],
        output='screen',
        emulate_tty=True,
    )
    ...
    tensorboard_node = IncludeLaunchDescription(
        ...
        launch_arguments={
            'log_dir': '/app/src/lunar_lander/data/logs',
            'port': '6005',
        }.items(),
